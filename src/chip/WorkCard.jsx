        ...
        return (
          ...
          >
            <POPUP className="img-content relative">
              <div className="h-[260px] w-[92%] hover:scale-125 transition duration-500 cursor-pointer shadow-xl rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] sm:bg-cover mx-auto">
                <img
                  src={data.img}
                  alt={data.title}
              ...
              <div
                className={` popup w-full  h-[260px] shadow-xl rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] p-4`}
              >
